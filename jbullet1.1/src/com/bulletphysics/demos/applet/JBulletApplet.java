...
public class JBulletApplet extends javax.swing.JApplet
{
		...
		try
		{
			EventQueue.invokeAndWait(new Runnable()
			{
				public void run()
				{
					...
					topPanel.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(0xCCCCCC), new Color(0xFFFFFF), new Color(0x333333),
							new Color(0x999999)));
	...
	private void initComponents()
	{
		...
		topPanel.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(204, 204,
				204), new java.awt.Color(255, 255, 255), new java.awt.Color(51, 51, 51), new java.awt.Color(153, 153, 153)));
		...
		topPanelLayout.setHorizontalGroup(topPanelLayout.createParallelGroup(Alignment.LEADING).addGroup(
				topPanelLayout.createSequentialGroup().addContainerGap().addComponent(jLabel1).addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(cmbDemos, GroupLayout.PREFERRED_SIZE, 236, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED, 84, Short.MAX_VALUE).addComponent(btnRestart).addContainerGap()));
		topPanelLayout.setVerticalGroup(topPanelLayout.createParallelGroup(Alignment.LEADING).addGroup(
				topPanelLayout
						...
						.addGroup(
								topPanelLayout
										...
										.addComponent(cmbDemos, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
